...
[[ -n "${OPENROUTER_API_KEY:-}" ]] && KEY_SETUP_EXTERNAL_KEYS+=(OPENROUTER_API_KEY)
[[ -n "${CUSTOM_LLM_API_KEY:-}" ]] && KEY_SETUP_EXTERNAL_KEYS+=(CUSTOM_LLM_API_KEY)
[[ -n "${CUSTOM_LLM_BASE_URL:-}" ]] && KEY_SETUP_EXTERNAL_KEYS+=(CUSTOM_LLM_BASE_URL)
[[ -n "${CUSTOM_LLM_MODEL:-}" ]] && KEY_SETUP_EXTERNAL_KEYS+=(CUSTOM_LLM_MODEL)
...
OPENROUTER_API_KEY="${OPENROUTER_API_KEY:-$(read_dotenv_value "OPENROUTER_API_KEY")}"
CUSTOM_LLM_API_KEY="${CUSTOM_LLM_API_KEY:-$(read_dotenv_value "CUSTOM_LLM_API_KEY")}"
CUSTOM_LLM_BASE_URL="${CUSTOM_LLM_BASE_URL:-$(read_dotenv_value "CUSTOM_LLM_BASE_URL")}"
CUSTOM_LLM_MODEL="${CUSTOM_LLM_MODEL:-$(read_dotenv_value "CUSTOM_LLM_MODEL")}"
...
put_env_if_set OPENROUTER_API_KEY "${OPENROUTER_API_KEY}"
put_env_if_set CUSTOM_LLM_API_KEY "${CUSTOM_LLM_API_KEY}"
put_env_if_set CUSTOM_LLM_BASE_URL "${CUSTOM_LLM_BASE_URL}"
put_env_if_set CUSTOM_LLM_MODEL "${CUSTOM_LLM_MODEL}"
