...
import deviceFeedsLayer from '../data/deviceFeeds.js';
...
export function createStandaloneData({
  ...
  dataManager.register(createApplicationDirectionsLayer());
  ...
  dataManager.register(deviceFeedsLayer);
  deviceFeedsLayer.attachDataManager(dataManager);
